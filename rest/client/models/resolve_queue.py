...
class ResolveQueue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "nameKey", "type"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResolveQueue from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResolveQueue from a dict"""
        if obj is None:
            return None
