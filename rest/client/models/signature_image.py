...
class SignatureImage(BaseModel):
    ...
    image_scanning_resolution: Optional[StrictStr] = Field(default=None, description="Enumeration of signature image scanning resolutions.", alias="imageScanningResolution")
    qualities: Optional[SignatureImageQualities] = None
    ...
    __properties: ClassVar[List[str]] = ["bitsPerPixel", "byteSize", "captureDevice", "colorSpace", "dataBytes", "dataUrl", "dpi", "format", "height", "horizontalPixelScale", "imageScanningResolution", "qualities", "resolutionDpi", "scaleUnit", "verticalPixelScale", "width"]
    ...
    @field_validator('image_scanning_resolution')
    def image_scanning_resolution_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in ('WITHING_RANGE', 'DIFFERENT'):
            raise ValueError("must be one of enum values ('WITHING_RANGE', 'DIFFERENT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SignatureImage from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SignatureImage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "imageScanningResolution": obj.get("imageScanningResolution"),
            "qualities": SignatureImageQualities.from_dict(obj.get("qualities")) if obj.get("qualities") is not None else None,
