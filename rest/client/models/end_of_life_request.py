...
class EndOfLifeRequest(BaseModel):
    """
    EndOfLifeRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["attachments", "reasonCode", "reasonText"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EndOfLifeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EndOfLifeRequest from a dict"""
        if obj is None:
            return None
