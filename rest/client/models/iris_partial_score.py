...
class IrisPartialScore(BaseModel):
    """
    IrisPartialScore
    """ # noqa: E501
    probe_index: Optional[StrictInt] = Field(default=None, alias="probeIndex")
    probe_position: Optional[StrictStr] = Field(default=None, description="Enumeration of iris positions.", alias="probePosition")
    reference_index: Optional[StrictInt] = Field(default=None, alias="referenceIndex")
    reference_position: Optional[StrictStr] = Field(default=None, description="Enumeration of iris positions.", alias="referencePosition")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IrisPartialScore from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IrisPartialScore from a dict"""
        if obj is None:
            return None
