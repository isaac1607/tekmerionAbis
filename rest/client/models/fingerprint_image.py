...
class FingerprintImage(BaseModel):
    """
    FingerprintImage
    """ # noqa: E501
    ...
    qualities: Optional[FingerprintImageQualities] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FingerprintImage from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FingerprintImage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "qualities": FingerprintImageQualities.from_dict(obj.get("qualities")) if obj.get("qualities") is not None else None,
