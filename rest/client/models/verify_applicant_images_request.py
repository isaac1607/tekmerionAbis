...
class VerifyApplicantImagesRequest(BaseModel):
    """
    VerifyApplicantImagesRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["extractionParameters", "gallery", "parameters", "references"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VerifyApplicantImagesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of VerifyApplicantImagesRequest from a dict"""
        if obj is None:
            return None
