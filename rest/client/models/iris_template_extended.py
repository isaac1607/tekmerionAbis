...
class IrisTemplateExtended(BaseModel):
    """
    IrisTemplateExtended
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dataBytes", "dataUrl", "position"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IrisTemplateExtended from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IrisTemplateExtended from a dict"""
        if obj is None:
            return None
