...
class FaceTemplateExtended(BaseModel):
    """
    FaceTemplateExtended
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dataBytes", "dataUrl"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FaceTemplateExtended from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FaceTemplateExtended from a dict"""
        if obj is None:
            return None
