...
class FullApplicantSmtCharacteristics(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["smtCharacteristics"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FullApplicantSmtCharacteristics from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FullApplicantSmtCharacteristics from a dict"""
        if obj is None:
            return None
