...
class IrisImageQualities(BaseModel):
    """
    IrisImageQualities
    """ # noqa: E501
    ...
    detection_quality: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="detectionQuality")
    iface_version: Optional[StrictStr] = Field(default=None, alias="ifaceVersion")
    iris_radius: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="irisRadius")
    ...
    pupil_radius: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pupilRadius")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "detectionQuality", "ifaceVersion", "irisRadius", "positionX", "positionY", "pupilRadius", "updatedAt", "valid"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IrisImageQualities from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IrisImageQualities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "detectionQuality": obj.get("detectionQuality"),
            "ifaceVersion": obj.get("ifaceVersion"),
            "irisRadius": obj.get("irisRadius"),
            "positionX": obj.get("positionX"),
            "positionY": obj.get("positionY"),
            "pupilRadius": obj.get("pupilRadius"),
