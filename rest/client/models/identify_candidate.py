...
class IdentifyCandidate(BaseModel):
    ...
    IdentifyCandidate
    """ # noqa: E501
    candidate_external_id: Optional[StrictStr] = Field(default=None, alias="candidateExternalId")
    score: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["candidateExternalId", "score"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "candidateExternalId": obj.get("candidateExternalId"),
            "score": obj.get("score")
        })
        return _obj
