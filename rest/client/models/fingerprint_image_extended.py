...
class FingerprintImageExtended(BaseModel):
    """
    FingerprintImageExtended
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dataBytes", "dataUrl", "format", "position", "resolutionDpi"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FingerprintImageExtended from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FingerprintImageExtended from a dict"""
        if obj is None:
            return None
