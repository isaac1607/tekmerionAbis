...
class CharacteristicImage(BaseModel):
    """
    CharacteristicImage
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["colorSpace", "dataBytes", "dataUrl", "format", "height", "horizontalPixelScale", "scaleUnit", "verticalPixelScale", "width"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CharacteristicImage from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CharacteristicImage from a dict"""
        if obj is None:
            return None
