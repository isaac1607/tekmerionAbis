...
class LatentTemplate(BaseModel):
    """
    LatentTemplate
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["byteSize", "dataBytes", "dataUrl", "format"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LatentTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LatentTemplate from a dict"""
        if obj is None:
            return None
