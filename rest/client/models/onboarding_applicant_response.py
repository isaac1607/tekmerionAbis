...
class OnboardingApplicantResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attachments", "category", "customDetails", "documents", "enrolledAt", "enrolledBy", "enrollmentDevice", "exportedAt", "exportedBy", "externalId", "gallery", "livenessPhotos", "originExternalId", "selfies", "status", "trustFactors"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OnboardingApplicantResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OnboardingApplicantResponse from a dict"""
        if obj is None:
            return None
