...
class MissingFingerprint(BaseModel):
    """
    MissingFingerprint
    """ # noqa: E501
    ...
    missing_reason_code: Optional[StrictStr] = Field(default=None, alias="missingReasonCode")
    missing_reason_text: Optional[StrictStr] = Field(default=None, alias="missingReasonText")
    ...
    __properties: ClassVar[List[str]] = ["impressionType", "index", "missingReasonCode", "missingReasonText", "position"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MissingFingerprint from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of MissingFingerprint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "missingReasonCode": obj.get("missingReasonCode"),
            "missingReasonText": obj.get("missingReasonText"),
