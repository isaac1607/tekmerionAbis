...
class DnaIdentificationCandidate(BaseModel):
    """
    DnaIdentificationCandidate
    """ # noqa: E501
    dna_partial_score: Optional[List[DnaPartialScore]] = Field(default=None, alias="dnaPartialScore")
    dna_score: Optional[StrictInt] = Field(default=None, alias="dnaScore")
    ...
    __properties: ClassVar[List[str]] = ["dnaPartialScore", "dnaScore", "externalId", "gallery", "id", "originExternalId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DnaIdentificationCandidate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DnaIdentificationCandidate from a dict"""
        if obj is None:
            return None
