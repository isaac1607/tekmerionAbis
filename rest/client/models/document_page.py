...
class DocumentPage(BaseModel):
    ...
    image_fields: Optional[List[ImageField]] = Field(default=None, alias="imageFields")
    orientation: Optional[StrictInt] = None
    text_fields: Optional[List[TextField]] = Field(default=None, alias="textFields")
    type: Optional[StrictStr] = None
    width: Optional[StrictInt] = None
    x: Optional[StrictInt] = None
    y: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["dataBytes", "dataUrl", "format", "height", "imageFields", "orientation", "textFields", "type", "width", "x", "y"]
