...
class FingerprintTemplate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["embeddingTemplate", "icsTemplate", "latentTemplate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FingerprintTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FingerprintTemplate from a dict"""
        if obj is None:
            return None
