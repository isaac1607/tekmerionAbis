...
class FaceCharacteristic(BaseModel):
    """
    FaceCharacteristic
    """ # noqa: E501
    ...
    eye_color_code: Optional[StrictStr] = Field(default=None, alias="eyeColorCode")
    face_description_details: Optional[List[str]] = Field(default=None, alias="faceDescriptionDetails")
    hair_colors: Optional[List[str]] = Field(default=None, alias="hairColors")
    image: Optional[CharacteristicImage] = None
    subject_pose_code: Optional[StrictStr] = Field(default=None, alias="subjectPoseCode")
    __properties: ClassVar[List[str]] = ["captureDate", "eyeColorCode", "faceDescriptionDetails", "hairColors", "image", "subjectPoseCode"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FaceCharacteristic from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FaceCharacteristic from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "eyeColorCode": obj.get("eyeColorCode"),
