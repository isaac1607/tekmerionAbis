...
class LatentVerificationCandidate(BaseModel):
    """
    LatentVerificationCandidate
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["externalId", "id", "latentPartialScore", "latentScore", "originExternalId", "verificationScore"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LatentVerificationCandidate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LatentVerificationCandidate from a dict"""
        if obj is None:
            return None
