...
class WorkflowsApplicant(BaseModel):
    """
    WorkflowsApplicant
    """ # noqa: E501
    ...
    manually_modified: Optional[StrictBool] = Field(default=None, alias="manuallyModified")
    ...
    __properties: ClassVar[List[str]] = ["externalId", "id", "manuallyModified", "originExternalId", "primary", "status"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WorkflowsApplicant from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WorkflowsApplicant from a dict"""
        if obj is None:
            return None
