...
class ApplicantIdentifierResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["externalId", "id", "originExternalId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApplicantIdentifierResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApplicantIdentifierResponse from a dict"""
        if obj is None:
            return None
