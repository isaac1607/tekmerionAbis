...
class DetectFaceQualitiesResponse(BaseModel):
    """
    DetectFaceQualitiesResponse
    """ # noqa: E501
    qualities: Optional[FaceImageQualities] = None
    __properties: ClassVar[List[str]] = ["qualities"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DetectFaceQualitiesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DetectFaceQualitiesResponse from a dict"""
        if obj is None:
            return None
