...
class FacePartialScore(BaseModel):
    """
    FacePartialScore
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["probeIndex", "referenceIndex", "score"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FacePartialScore from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FacePartialScore from a dict"""
        if obj is None:
            return None
