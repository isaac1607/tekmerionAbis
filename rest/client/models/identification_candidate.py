...
class IdentificationCandidate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["externalId", "facePartialScore", "faceScore", "fingerprintEmbeddingPartialScore", "fingerprintEmbeddingScore", "fingerprintPartialScore", "fingerprintScore", "gallery", "id", "irisPartialScore", "irisScore", "originExternalId", "score"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IdentificationCandidate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IdentificationCandidate from a dict"""
        if obj is None:
            return None
