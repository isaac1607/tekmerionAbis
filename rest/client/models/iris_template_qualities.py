...
class IrisTemplateQualities(BaseModel):
    """
    ...
    template_quality: Optional[StrictInt] = Field(default=None, alias="templateQuality")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "ifaceVersion", "templateQuality", "updatedAt", "valid"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IrisTemplateQualities from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IrisTemplateQualities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "templateQuality": obj.get("templateQuality"),
