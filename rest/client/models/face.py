...
class Face(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["boundingBox", "captureDate", "captureMode", "icaoAttributes", "image", "index", "photoRatio", "subjectAcquisitionProfile", "subjectPoseCode", "template"]
