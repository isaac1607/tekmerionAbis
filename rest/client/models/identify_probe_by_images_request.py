...
class IdentifyProbeByImagesRequest(BaseModel):
    """
    IdentifyProbeByImagesRequest
    """ # noqa: E501
    ...
    probe: Optional[BiometricDataImages] = None
    __properties: ClassVar[List[str]] = ["extractionParameters", "gallery", "identificationParameters", "probe"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IdentifyProbeByImagesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IdentifyProbeByImagesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "probe": BiometricDataImages.from_dict(obj.get("probe")) if obj.get("probe") is not None else None
        })
        return _obj
