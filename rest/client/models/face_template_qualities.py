...
class FaceTemplateQualities(BaseModel):
    """
    FaceTemplateQualities
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "ifaceVersion", "quality", "templateVersion", "updatedAt", "valid"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FaceTemplateQualities from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FaceTemplateQualities from a dict"""
        if obj is None:
            return None
