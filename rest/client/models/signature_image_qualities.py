...
class SignatureImageQualities(BaseModel):
    """
    SignatureImageQualities
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "valid"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SignatureImageQualities from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SignatureImageQualities from a dict"""
        if obj is None:
            return None
