...
class IndividualWithLockVersion(BaseModel):
    """
    IndividualWithLockVersion
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["individualId", "lockVersion"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IndividualWithLockVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IndividualWithLockVersion from a dict"""
        if obj is None:
            return None
