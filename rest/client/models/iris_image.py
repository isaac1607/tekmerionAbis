...
class IrisImage(BaseModel):
    ...
    qualities: Optional[IrisImageQualities] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IrisImage from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IrisImage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "qualities": IrisImageQualities.from_dict(obj.get("qualities")) if obj.get("qualities") is not None else None,
