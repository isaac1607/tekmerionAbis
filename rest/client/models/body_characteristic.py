...
class BodyCharacteristic(BaseModel):
    """
    BodyCharacteristic
    """ # noqa: E501
    body_description_details: Optional[List[BodyDescriptionDetail]] = Field(default=None, alias="bodyDescriptionDetails")
    ...
    __properties: ClassVar[List[str]] = ["bodyDescriptionDetails", "captureDate", "image"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BodyCharacteristic from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BodyCharacteristic from a dict"""
        if obj is None:
            return None
